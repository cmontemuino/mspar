 ...
 */
char*
generateSample(int myRank, int samples, struct params parameters, unsigned maxsites, double **positions)
{
    int gensam(char **gametes, double *probss, double *ptmrca, double *pttot, struct params pars);
    ...
    segsites = gensam(gametes, &probss, &tmrca, &ttot, parameters);
